...
| `GET /api/u/{handle}/decks/{deck_id}/goldfish` | `GoldfishHand` — the public mirror of the goldfish read, same query parameters; one seed deals one hand whoever asks. `404` if private/absent |
