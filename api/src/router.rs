...
use crate::{
    ...
    handlers::{
        ...
        decks::{
            ...
            create_section, deck_bracket, deck_goldfish, deck_legality, deck_mana, deck_roles,
        ...
        sharing::{
            ...
            public_deck_goldfish, public_deck_legality, public_deck_mana, public_deck_roles,
