...
pub use decks::{
    ...
    public_deck_roles, public_deck_stats, public_deck_tokens, public_decks,
};
pub use public::{
...
pub use decks::{
    ...
    __path_public_deck_legality, __path_public_deck_mana, __path_public_deck_roles,
    __path_public_deck_stats, __path_public_deck_tokens, __path_public_decks,
};
pub use public::{
