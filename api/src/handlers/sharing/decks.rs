...
use crate::handlers::decks::{
    ...
    analyse_goldfish, analyse_legality, analyse_mana, analyse_roles, analyse_stats, analyse_tokens,
    deck_detail, deck_headers, load_analysis, load_analysis_with_cards,
};
