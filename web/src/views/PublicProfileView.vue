...
import { Library, UserCircle } from '@lucide/vue'
import { usePublicProfileQuery } from '@/composables/usePublicCollection'
import { formatUsd } from '@/lib/money'
import { usePageMeta } from '@/lib/seo'

// A user's public profile (issues #361/#362): their handle + the game collections they've
// made public, each linking to the read-only collection page. Unauthenticated and
// indexable. A 404 (unknown handle or no public games) renders the not-found state.
